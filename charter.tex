...
\begin{enumerate}
	...
	\item Desarrollo del hardware (60 horas)
		\begin{enumerate}
			...
			\item Ruteo del PCB y fabricación de un prototipo (30 horas)
	...
	\item Presentación del proyecto (70 horas)
		\begin{enumerate}
			\item Escritura del informa de avance (15 horas)
			\item Escritura del informa final (40 horas)
			\item Escritura de la presentación pública (15 horas)
		\end{enumerate}
\end{enumerate}

Cantidad total de horas: 665 horas
